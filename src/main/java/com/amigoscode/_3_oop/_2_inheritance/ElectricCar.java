...
public class ElectricCar extends Vehicle {
    ...
    @Override
    public void start() {
        System.out.printf("%s %s electric motor starting silently...", make, model);
    }
    ...
    public void charge(int percent) {
        ...
        System.out.printf("Charging... Battery now at %d%%%n", batteryLevel);
    ...
    public String getBatteryStatus() {
        return String.format("Battery: %d", batteryLevel);
    }
