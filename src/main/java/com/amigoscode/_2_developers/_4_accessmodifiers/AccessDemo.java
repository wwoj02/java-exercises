...
public class AccessDemo {
    ...
    public static void main(String[] args) {
        ...
        accessModifiers.setSecret("12345");
...
//        well it's not gonna work cause an attribute with private access modifier can be accessed or override only
//        from inside the class or using a public methods such as a getter/setter if it were implemented
