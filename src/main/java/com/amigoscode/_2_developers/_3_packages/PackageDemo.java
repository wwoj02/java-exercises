...
public class PackageDemo {
    ...
    public static void useFullyQualifiedName() {
        ...
        java.util.HashMap<String, Integer> myHashMap = new java.util.HashMap<>();
        myHashMap.put("Alice", 90);
        myHashMap.put("Bob", 85);
    ...
    public static void useClassFromAnotherPackage() {
        ...
        String result = com.amigoscode._2_developers._2_conditionals.IfStatements.getDayName(3);
