...
public class FunctionExercise {
    ...
    public static void main(String[] args) {
        ...
        Function<String, Integer> chainedFunc = toUpperCase.andThen(stringLength);
        System.out.println(chainedFunc.apply("wojtek"));
        ...
        Function<String, Integer> composedFunc = stringLength.compose(toUpperCase);
        System.out.println(composedFunc.apply("wojtek"));
        ...
        Function<Integer, String> intToWord = digit -> {
            return switch (digit) {
                case 1 -> "one";
                case 2 -> "two";
                case 3 -> "three";
        ...
        System.out.println(intToWord.apply(3));
