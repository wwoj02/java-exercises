...
public class CallbackExercise {
    ...
    public static void main(String[] args) {
        ...
        CallbackExercise callbackExercise = new CallbackExercise();
        callbackExercise.fetchData(
            true,
            data -> System.out.println("Data received: %s".formatted(data)),
            data -> System.out.println("Error occured: %s".formatted(data))
        );
        callbackExercise.fetchData(
            false,
            data -> System.out.println("Data received: %s".formatted(data)),
