...
public class EventProcessor {
    ...
    public static void main(String[] args) {
        ...
        processor.addListener(
                "onClick",
                data -> System.out.println("Button clicked! Data: %s".formatted(data)));
        processor.addListener(
                "onClick",
                data -> System.out.println("Logging click event: %s".formatted(data)));
        processor.addListener(
                "onClick",
                data -> System.out.println("Analytics: tracking click - %s".formatted(data)));
        ...
        processor.addListener(
                "onHover",
                data -> System.out.println("Hovering over: %s".formatted(data)));
