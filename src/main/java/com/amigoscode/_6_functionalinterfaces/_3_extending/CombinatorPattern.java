...
public class CombinatorPattern {
    ...
    interface CustomerValidator extends Function<Customer, ValidationResult> {
        ...
        static CustomerValidator isNameNotEmpty() {
            return customer -> (customer.name != null && !customer.name.isEmpty()) ?
                    ValidationResult.SUCCESS : ValidationResult.NAME_EMPTY;
        }
    ...
    public static void main(String[] args) {
        ...
        Customer customer1 = new Customer("Bob", "bob-no-email", 30);
        Customer customer2 = new Customer("", "young@email.com", 16);
        Customer customer3 = new Customer("", "valid@email.com", 25);

        System.out.println(fullValidator.apply(customer1));
